...
for patient in patient_list:
    ...
    save_path = base_path + '/test/img'
    save_path2 = base_path + '/test/seg'
...
# # train
# for patient in patient_list[split:]:
#     dir_path = img_dir + '/{}'.format(patient)
#     dir_path2 = anno_dir + '/{}'.format(patient)

#     print('train patient : {}'.format(patient))

#     img_list = natsort.natsorted(os.listdir(dir_path))[::30]
#     seg_list = natsort.natsorted(os.listdir(dir_path2))[::30]

#     save_path = base_path + '/train/img'
#     save_path2 = base_path + '/train/seg'
#     os.makedirs(save_path, exist_ok=True)
#     os.makedirs(save_path2, exist_ok=True)
...
#     print('val patient : {}'.format(patient))

#     img_list = natsort.natsorted(os.listdir(dir_path))[::30]
#     seg_list = natsort.natsorted(os.listdir(dir_path2))[::30]

#     save_path = base_path + '/val/img'
#     save_path2 = base_path + '/val/seg'
